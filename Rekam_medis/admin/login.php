                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <img class="mt-2" src="img/hospital.png" alt="Virus" width="100px" height="100px">
                                        <hr>
                                        <h1 class="h4 text-gray-900 mb-4">Aplikasi Balai Pengobatan Desa </h1>
                                    </div>
                                    <form class="user" action="login_proses.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <button class="btn btn-primary btn-user btn-block" name="pesan">
                                            Login
                                        </button>
                                    </form>
                                </div>
